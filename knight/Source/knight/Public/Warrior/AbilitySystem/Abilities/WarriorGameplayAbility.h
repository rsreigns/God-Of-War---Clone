 ...
 */
UCLASS()
class KNIGHT_API UWarriorGameplayAbility : public UGameplayAbility
{
	GENERATED_BODY()

protected:
	// Start GameplayAbility Interface
	...
	UFUNCTION(BlueprintPure, Category = "Warrior | Ability")
	UWarriorHeroGameplayAbility* GetWarriorGameplayAbilityFromActorInfo() const;
	...
	UFUNCTION(BlueprintCallable, Category = "Warrior | Ability", meta = (ExpandEnumAsExecs = "OutSuccessType"))
